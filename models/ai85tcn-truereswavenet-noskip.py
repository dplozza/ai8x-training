...
Incomplete wavenet (only res and NO skip connections)

CORRECTION: residual convs do NOT have RELU!!!!!!!
"""
import torch
...
def _conv_stack_relu(dilations, in_channels, out_channels, kernel_size,bias=True,**kwargs):
    """
...
class AI85tcn(nn.Module):
    ...
    def __init__(self,num_classes=1, num_channels=1,dimensions=(128,),
        ...
        self.hidden = _conv_stack_relu(dilations, num_hidden_channels, num_hidden_channels, kernel_size,bias=bias)
...
def ai85truereswavenet_noskip(pretrained=False, **kwargs):
    """
...
models = [
    {
        'name': 'ai85truereswavenet_noskip',
